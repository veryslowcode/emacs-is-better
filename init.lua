...
-- Tab Mappings {{{
-- (normal mode) 
vim.keymap.set("n", "<leader>tao", ":tabnew|Telescope find_files<CR>", {desc = "[Ta]b [O]pen"})
vim.keymap.set("n", "<leader>tax", ":tabnew|Telescope file_browser layout_config={}<CR>", {desc = "[Ta]b E[x]plore"})
