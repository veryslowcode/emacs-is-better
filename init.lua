...
-- Tab Mappings {{{
-- (normal mode)
vim.keymap.set("n", "<leader>tao", ":tabnew|Alpha<CR>", { desc = "[Ta]b [O]pen" })
...
vim.keymap.set("n", "<leader>fec", ":Telescope file_browser path=%:p:h select_buffer=true<CR>",
    { desc = "[F]ile [E]xplorer [C]urrent" })
--
-- }}}
